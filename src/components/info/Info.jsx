		...
		<div className="">
			<div className="bg-Ghost-White flex flex-col justify-center items-center gap-10 px-4 pt-16">
				<div className="infoCard flex flex-col items-center justify-center">
					...
					<h2 className="font-Fraunces text-2xl my-6 text-Dark-Purple">Actionable insights</h2>
					<p className="leading-7 text-Davys-Gray">
				...
				<div className="infoCard flex flex-col items-center justify-center">
					...
					<h2 className="font-Fraunces text-2xl my-6 text-Dark-Purple">Data-driven decisions</h2>
					<p className="leading-7 text-Davys-Gray">
				...
				<div className="infoCard flex flex-col items-center justify-center">
					...
					<h2 className="font-Fraunces text-2xl my-6 text-Dark-Purple">Always affordable</h2>
					<p className="leading-7 text-Davys-Gray">
